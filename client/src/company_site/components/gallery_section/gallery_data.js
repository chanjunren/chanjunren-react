...
const galleryData = [
  {
    ...
    gallery: [
      {
        src: getS3AssetUrl('health_res1.mp4'),
        type: VID_TYPE,
      },
      {
        src: HealthRes2,
  ...
  },
  {
    ...
    gallery: [
      {
        src: getS3AssetUrl('guide_res1.mp4'),
        type: VID_TYPE,
      },
    ],
  },
  {
    ...
    gallery: [
      {
        src: getS3AssetUrl('edu_res1.mp4'),
        type: VID_TYPE,
      },
    ],
  },
  ...
  
  {
    ...
    gallery: [
      {
        src: getS3AssetUrl('others_res1.mp4'),
        type: VID_TYPE,
      },
      {
        src: getS3AssetUrl('others_res2.mp4'),
        type: VID_TYPE,
      },
    ],
  },
