...
const AuthPage = () => {
  const [userInputFocused, passInputFocused,
    focusUserInput, focusPassInput,
    unFocusUserInput, unFocusPassInput] = useAuth();
  return (
    <>
